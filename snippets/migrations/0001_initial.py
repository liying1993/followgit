    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_date', models.DateField()),
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.Manufacturer')),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
        ...
        migrations.AddField(
            model_name='instrunment',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snippets.Musician'),
        ),
